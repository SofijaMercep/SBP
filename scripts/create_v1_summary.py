...
RESULTS_DIR = Path("v1/results")
OUTPUT_TXT = RESULTS_DIR / "v1_summary.txt"
OUTPUT_CSV = RESULTS_DIR / "v1_summary.csv"
...
def main():
    ...
    for question_number in range(1, 6):
        file_path = RESULTS_DIR / f"question_{question_number}_v1_results.txt"
    ...
    lines = []
    lines.append("V1 SUMMARY - NEOPTIMIZOVANA SEMA")
    lines.append("=" * 60)
    ...
    csv_lines = ["question,v1_time_seconds,result_count,file"]
